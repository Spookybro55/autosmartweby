...
### [B/B-13] Email template schema + CRUD + runtime wiring + bootstrap + backend + API layer + UI listing + editor + consumer integration + analytics dashboard (T1-T9 + T11 of 13-task email templating + analytics project; T10 deferred to backlog) — ANALYTICS_DONE
