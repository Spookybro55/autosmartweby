...
> **Canonical lifecycle:** Autoritativni end-to-end lifecycle state machine je definovana v `docs/21-business-process.md`, sekce "Lead Lifecycle State Machine — C-01". Nize uvedene state machines jsou **auxiliary** vrstvove detaily; kanonicky stav leadu (`lifecycle_state`) je vzdy prave 1 a odvozuje se z kombinace techto poli.
