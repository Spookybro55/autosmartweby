...
| AGENT-TEAM-MAKE-BLUEPRINTS-REAL-IDS | B | Make blueprints — explicit HTTP-only chains wit... | Claude Code (Sonnet 4.6, autonomous Playwright run) | docs-guardian | code-complete | 2026-04-30 | docs/30-task-records/AGENT-TEAM-MAKE-BLUEPRINTS-REAL-IDS.md, docs/agents/make/0{1..5}-*.json, docs/11-change-log.md, docs/29-task-registry.md | docs, scripts |
...
| B6 | B | Minimal preview review layer | Stream B | - | done | 2026-04-21 | docs/20-current-state.md, docs/22-technical-architecture.md, docs/23-data-model.md, docs/26-offer-generation.md | apps-script, scripts, package.json, docs |
...
| DP-001 | B | Replace hardcoded PROD Sheet ID in `preview-ren... | Stream B | docs-guardian | code-complete | 2026-04-30 | `docs/audits/FINDINGS.md`, `docs/30-task-records/DP-001-prod-sheet-id-test-fixture.md`, `docs/agents/QUEUE.md`, `docs/11-change-log.md`, `docs/29-task-registry.md` | `scripts |
| DP-003 | B | Make `scripts/clasp-deploy.sh` PROD swap atomic... | Stream B | bug-hunter | code-complete | 2026-04-30 | `docs/audits/FINDINGS.md`, `docs/30-task-records/DP-003-clasp-deploy-trap-restore.md`, `docs/agents/QUEUE.md`, `docs/agents/RUN-LOG.md`, `docs/agents/QUESTIONS-FOR-HUMAN.md`, `docs/11-change-log.md`, `docs/29-task-registry.md` | `scripts, `package.json` |
