...
| B-08 | B | Pilot 10 leadu preview — preparation / runbook ... | Stream B | READY_FOR_EXECUTION | 2026-04-24 | docs/30-task-records/B-08.md, docs/11-change-log.md, docs/29-task-registry.md | — |
