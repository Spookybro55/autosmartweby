...
| B-13 | B | Email template schema + CRUD (T1+T2 of 13-task ... | Stream B | CRUD_DONE | 2026-04-27 | docs/30-task-records/B-13.md, docs/11-change-log.md, docs/29-task-registry.md | apps-script |
