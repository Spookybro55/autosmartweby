...
| A2 | A | RAW_IMPORT Staging Layer | Stream A | in-progress | 2026-04-05 | docs/23-data-model.md, docs/24-automation-workflows.md, docs/30-task-records/A2.md | docs, crm-frontend |
