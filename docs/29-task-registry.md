...
| A3 | A | Normalization Raw to LEADS Rules | Stream A | in-progress | 2026-04-05 | docs/23-data-model.md, docs/24-automation-workflows.md, docs/30-task-records/A3.md | docs |
