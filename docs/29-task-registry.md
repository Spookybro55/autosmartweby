...
| B-13 | B | Email template schema migration (T1 of 13-task ... | Stream B | SCHEMA_DONE | 2026-04-27 | docs/30-task-records/B-13.md, docs/11-change-log.md, docs/29-task-registry.md | apps-script |
