...
| B-13 | B | Email template schema + CRUD + runtime wiring +... | Stream B | ANALYTICS_DONE | 2026-04-28 | docs/30-task-records/B-13.md, docs/11-change-log.md, docs/29-task-registry.md | apps-script, crm-frontend |
