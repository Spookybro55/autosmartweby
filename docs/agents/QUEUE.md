...
|---|---|---|---|---|
| 1 | DP-001: PROD Sheet ID hardcoded v test fixture (test code committed do main... | P0 | docs-guardian | B |
| 2 | SEC-001: Hardcoded production Sheet ID (`1RBc…`, 44 znaků) v 5+ tracked soub... | P0 | security-engineer | B |
| 3 | DP-003: `scripts/clasp-deploy.sh:74-87` swap-and-restore není atomic. Pokud... | P1 | docs-guardian | B |
| 4 | DP-004: `apps-script/PreviewPipeline.gs:976,1561` posílá `spreadsheet_id: S... | P1 | docs-guardian | B |
| 5 | DP-009: Vercel deploy je úplně mimo repo. Žádný `vercel.json`, žádný `.verc... | P1 | docs-guardian | B |
| 6 | DP-010: Branch protection na `main` má `enforce_admins: false`. Repo admin ... | P1 | docs-guardian | B |
| 7 | DP-014: `docs/27-infrastructure-storage.md` má multi-line drift: tvrdí "Fro... | P1 | docs-guardian | B |
| 8 | DP-019: Žádná dokumentovaná secrets rotation procedura pro `FRONTEND_API_SE... | P1 | docs-guardian | B |
| 9 | FF-003: `processPreviewQueue` (15-min cron trigger) **nepoužívá LockService... | P1 | bug-hunter | A |
| 10 | FF-009: C-04 Sendability gate je SPEC-ONLY (per `docs/30-task-records/C-04.... | P1 | bug-hunter | A |
